...
export const isAccessTokenValid = ( token: string ) => verify(token, process.env.ACCESS_TOKEN_SECRET as string );
export const isRefreshTokenValid = ( token: string ) => verify(token, process.env.REFRESH_TOKEN_SECRET as string);
